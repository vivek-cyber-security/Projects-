...
$sql ="SELECT ID FROM admin WHERE ID=:adminid and pwd=:cpassword";
...
if($query -> rowCount() > 0)
{
$con="update admin set pwd=:newpassword where id=:adminid";
...
<!doctype html>
 <html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
 <title>Royal Banquet Booking System - Change Password</title>
