...
$sql="delete from service where ID=:rid";
...
<head>
    <title>RoyalBanquet - Manage Services</title>
        ...
        foreach ($results as $row) {   
                     ?>
                                <tr>
                                    ...
                                    <td class="font-w600"><?php  echo htmlentities($row["sname"], ENT_QUOTES, 'UTF-8');?></td>
                                    <td class="d-none d-sm-table-cell">$<?php  echo htmlentities($row['sprice']);?>
                                    </td>
                                    <td class="d-none d-sm-table-cell">
                                        <span
                                            class="badge bg-primary"><?php  echo htmlentities($row['createdate']);?></span>
                                    </td>
                                    <td class="d-none d-sm-table-cell "><a
                                            href="manage-services.php?delid=<?php echo ($row['id']);?>"
                                            onclick="return confirm('Do you really want to Delete ?');"><i
                                                class="fa fa-trash fa-delete text-primary" aria-hidden="true"></i></a>
                                    </td>
                                </tr>
                                <?php $cnt=$cnt+1;}} ?>
