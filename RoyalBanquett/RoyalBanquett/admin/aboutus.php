...
$sql="update page set ptitle=:pagetitle,pdescription=:pagedes where  Ptype='aboutus'";
...
<!doctype html>
 <html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
 <title>RoyalBanquet  - Update About Us</title>
...
// {    
// 
$sql = "SELECT * FROM page WHERE ptype = 'aboutus'";
$query = $dbh->prepare($sql);
...
if ($results) {  
    foreach ($results as $row) {           ?>        
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12">
                                                 <input type="text" name="pagetitle" value="<?php  echo ($row['ptitle'])?>" class="form-control" required='true'>
                                            </div>
                                        </div>
                                        <div class="form-group row">
