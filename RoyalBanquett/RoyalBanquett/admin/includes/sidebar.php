   ...
   <nav id="sidebar" class=" bg-primary">
                ...
                <div id="sidebar-scroll ">
                    ...
                    <div class="sidebar-content bg-primary">
                        <!-- Side Header -->
                        <div class="content-header content-header-fullrow px-15 bg-primary">
                            <!-- Mini Mode -->
                            ...
                            <!-- Normal Mode -->
                            <div class="content-header-section text-center align-parent sidebar-mini-hidden bg-primary">
                                ...
                                <div class="content-header-item">
                                    <a class="link-effect font-w700" href="dashboard.php">
                                        ...
                                        <!-- <span class="font-size-xl text-dual-primary-dark">RoyalBanquet </span>| -->
                                         <span class="font-size-xl text-primary">ADMIN</span>
                                    </a>
                                </div>
                                <!-- END Logo -->
                            </div>
                        ...
                        <!-- Side User -->
                        <div class="content-side content-side-full content-side-user px-10 align-parent bg-primary-light">
                            <!-- Visible only in mini mode -->
                            <div class="sidebar-mini-visible-b align-v animated fadeIn">
                                <img class="img-avatar img-avatar32" src="assets/img/avatars/Admin.png" alt="">
                            </div>
                            ...
                            <div class="sidebar-mini-hidden-b text-center">
                                <a class="img-link" href="dashboard.php">
                                    <img class="img-avatar" src="assets/img/avatars/Admin.png" alt="">
                                </a>
...
// {  
    $aid=$_SESSION['odmsaid'];
    $sql="SELECT aname FROM  admin WHERE id=:aid";
    $query = $dbh->prepare($sql);
    $query->bindParam(':aid',$aid,PDO::PARAM_STR);
...
if ($results) {  
        foreach ($results as $row) {             ?>
                                    <li class="list-inline-item">
                                        <a class="link-effect text-dual-primary-dark font-size-xs font-w600 text-uppercase" href="admin-profile.php"><?php  echo ($row['aname']);?></a>
                                    </li><?php $cnt=$cnt+1;}} ?>
                                    <li class="list-inline-item">
                                        <!-- Layout API, functionality initialized in Codebase() -> uiApiLayout() -->
                        ...
                        <div class="content-side content-side-full bg-primary">
                            <ul class="nav-main">
                                ...
                                <li>
                                    <a class="nav-submenu bg-primary " data-toggle="nav-submenu"><i class="si si-puzzle"></i><span class="sidebar-mini-hide "></span>Services</a>
                                    <ul class="bg-pimary">
                                        <li class="bg-primary" >
