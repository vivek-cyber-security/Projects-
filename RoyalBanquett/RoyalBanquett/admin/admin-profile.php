...
if (strlen($_SESSION['odmsaid']==0)) {
  ...
  $email=$_POST['email'];
  $sql="update admin set aname=:adminname,mobnumber=:mobilenumber,email=:email where id=:aid";
...
<head>
    <title>Royal Banquet Booking System - Admin Profile</title>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12">
                                            <input type="text" class="form-control" name="adminname"
                                                value="<?php  echo ($row->aname);?>" required='true'>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12">
                                            <input type="text" class="form-control" name="username"
                                                value="<?php  echo ($row->uname);?>" readonly="true">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12">
                                            <input type="text" class="form-control" name="mobilenumber"
                                                value="<?php  echo ($row->mobnumber);?>" required='true'
                                                maxlength='10'>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12">
                                            <input type="text" class="form-control" id="email2" name=""
                                                value="<?php  echo ($row->aregdate);?>" readonly="true">
                                        </div>
                                    </div>
                                    <?php $cnt=$cnt+1;}} ?>
                                    <div class="form-group row">
